import { EllipticCurve, Point } from './core.js'

export const secp192k1 = new EllipticCurve(
...
export const secp192r1 = new EllipticCurve(
...
export const secp224k1 = new EllipticCurve(
...
export const secp224r1 = new EllipticCurve(
...
export const secp256r1 = new EllipticCurve(
...
export const secp384r1 = new EllipticCurve(
  BigInt(
...
export const secp521r1 = new EllipticCurve(
  BigInt(
...
export function get(name) {
  if (!Object.prototype.hasOwnProperty.call(curve_dict, name)) {
